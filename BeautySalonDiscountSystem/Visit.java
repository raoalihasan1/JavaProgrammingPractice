package JavaProgrammingPractice.BeautySalonDiscountSystem;
...
public class Visit {
    ...
    public double getTotalExpense() {
        if (theCustomer.isMember()) {
            new DiscountRate();
            double serviceDiscount = DiscountRate.getServiceDiscountRate(theCustomer.getMemberType());
            double productDiscount = DiscountRate.getProductDiscountRate(theCustomer.getMemberType());
